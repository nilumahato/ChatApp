...
import 'package:bolchaal/widgets/message_card.dart';
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: SafeArea(
        //if emojis are shwon & back button is pressed then hide emojis
          ...
          child: Scaffold(
            ...
            body: Column(
              children: [
                ...
                //showing emoji on keyboard emoji button click & vice versa
                if (_showEmoji)
                  SizedBox(
                    height: mq.height * .35,
                    child: EmojiPicker(
                      ...
                      config: Config(
                        ...
                        iconColorSelected: Colors.brown,
